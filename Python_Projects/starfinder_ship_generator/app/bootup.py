...
def insertData():
    ...
    sql.tableInsert("Weapons",'"Name","Range","Speed","Damage","PCU","Special","Cost"',
                    '"Chain Cannon","Short(5)",0,"6d4",15,1,10',cur,con)
    sql.tableInsert("Weapons",'"Name","Range","Speed","Damage","PCU","Special","Cost"',
                    '"Grazer","Short(5)",0,"7d10",40,2,35',cur,con)
    sql.tableInsert("Weapons",'"Name","Range","Speed","Damage","PCU","Special","Cost"',
                    '"Gravity Cannon","Long(20)",0,"2d6*10",40,3,50',cur,con)
